    ...
    <div class="container mt-5 item-detail">
        <div class="row mr-0">
            <div class="col-lg-6 col-md-6 col-sm-12">
             <img src="assets/img/Hyagel-4a.jpg" class="img-fluid" id="a">
             <img src="assets/img/Hyagel-4b.jpg" class="img-fluid" id="b">
             <img src="assets/img/Hyagel-4c.jpg" class="img-fluid" id="c">
             <div class="row mr-0">
                 <div class="col-lg-4 col-md-3 col-sm-12">
                     <img src="assets/img/Hyagel-4a.jpg" class="img-fluid" onclick="myfunction1()">
                 </div>
                 <div class="col-lg-4 col-md-3 col-sm-12">
                     <img src="assets/img/Hyagel-4b.jpg" class="img-fluid" onclick="myfunction2()">
                 </div>
                 <div class="col-lg-4 col-md-3 col-sm-12">
                     <img src="assets/img/Hyagel-4c.jpg" class="img-fluid" onclick="myfunction3()">
                 </div>
             </div>
         </div>
         <div class="col-lg-6 col-md-6 col-sm-12">
